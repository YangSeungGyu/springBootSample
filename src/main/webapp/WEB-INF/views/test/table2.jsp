...
//-------------------------------------------------		
	function setBackgroundImg(listCnt){
		...
		var tdWidth = $("#main02TdTop_1").outerWidth(true)+1.5; //table space 값 및 기타 오류값
		
		//이미지 시작위치 div+첫번째 td
		var firstPosition = ($("#dsDeckSubTitle").outerWidth(true)+$("#main02TdTop_0").outerWidth(true))+2;
